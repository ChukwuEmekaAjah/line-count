def count_lines(file, flags = {}):
	"""
		a function to count the number of lines in a file based on absence or presence of some flags
...
def is_not_comment(file_line):
	"""
		check if the file line is a python comment
		:param file_line: a string of characters representing a line in a file
		:return bool
	"""
	stripped_line = file_line.strip()
...
def remove_docs(file_lines):
	'''
		remove documentation lines in class and function bodies
